...
- Twelve Labs와 Beeble co-founder들은 병특 중에 만났었고 미국의 최고 스타트업들 (Pika, Perplexity, Luma)은 모두 대학원생들이 연구와 프로젝트를 하면서 스타트업으로 이루어졌습니다. 저희도 서울에서 뛰어난 분들이 같이 사이드 프로젝트를 진행하며 연구와 스타트업으로 이어져서 임팩트를 낼 수 있는 곳이 되려고합니다!
